...
if __name__ == '__main__':
    ...
    scale_momentum = 128 # added
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu') # added
    norm = torch.tensor([1./scale_momentum, 1./scale_momentum, 1./scale_momentum, 1., 1., 1., 1., 1.]).to(device)   # added # pt, px, py: scale by 128      
    model = net.Net(8, 3, norm).to('cuda') # modified
